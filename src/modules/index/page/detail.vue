<template>
  <div class="detail higtlight" id="blog">
    ...
    <section class="article" v-else>
      ...
      <!-- 许可 -->
      <div class="posmition">
        <p>文章版权所有：<a href="https://github.com/yueyuluo" target="_black">理想</a>，采用 <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh" target="_black">知识共享署名-非商业性使用 4.0 国际许可协议</a> 进行许可。</p>
